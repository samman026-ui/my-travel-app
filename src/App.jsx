...
function TripPage({ trip, onBack, onOpenAI, onUpdate, syncStatus }) {
  ...
  return (
    ...
    <div style={{ display:"flex", flexDirection:"column", height:"100%", overflow:"hidden", background:C.bg }}>
      ...
      {/* ── Sticky tab bar ── */}
      <div style={{ display:"flex", background:C.surface, borderBottom:`1px solid ${C.border}`, flexShrink:0, overflowX:"auto", WebkitOverflowScrolling:"touch" }}>
        {INNER_TABS.map(t=>(
  ...
  return (
    ...
    <div style={{
      ...
      <div style={{
        flexShrink: 0,
        background: C.bg,
        /* Respect Dynamic Island / notch on real device */
        paddingTop: "max(env(safe-area-inset-top), 44px)",
        /* Subtle bottom border to separate from scroll content */
  ...
  return (
    <div style={{ display:"flex", justifyContent:"center", alignItems:"flex-start", minHeight:"100vh", background:"#111", padding:"20px 0" }}>
      <style>{`
        ...
        /* ── Lock body scroll globally ── */
        html, body {
          margin: 0; padding: 0;
          height: 100%; width: 100%;
          overflow: hidden;               /* prevent whole-page drag */
          background: #0A0A0C;
        ...
        * { scrollbar-width: none; -ms-overflow-style: none; }
        ...
        /* ── iOS rubber-band scrolling helper ── */
        .scroll-area {
          overflow-y: auto;
      ...
      {/* Phone shell for preview — in production on a real device this wrapper is just the viewport */}
      <div style={{
        ...
        /* Critical: lock this shell — no scrolling on the shell itself */
        display: "flex", flexDirection: "column",
      }}>
