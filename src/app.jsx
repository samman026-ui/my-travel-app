  ...
  return (
    <div style={{ padding:"0 16px", display:"flex", flexDirection:"column", gap:10 }}>
      ...
      <div ref={containerRef} style={{ display:"flex", flexDirection:"column", gap:10 }}>
        {days.map((d, di) => {
          const times = calcTimes(d.spots, d.transportTime);
          ...
          const endH = Math.floor((8*60+30+totalMins)/60)%24;
          const endM2 = (8*60+30+totalMins)%60;
          ...
          return (
            <div key={d.id} className="day-card" style={{
              ...
              userSelect:"none",
              /* NO touchAction here — cards must allow scroll */
            }}>
              <div style={{ background:C.surface2, padding:"12px", display:"flex", alignItems:"center", gap:10 }}>
                {/* Drag handle — ONLY this gets touchAction:none */}
                <div
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  ...
                  <div style={{ fontSize:10, color:tc, fontFamily:C.mono, marginTop:2 }}>🚗 {d.transport} · {d.transportTime}分鐘 | 08:30 → {String(endH).padStart(2,"0")}:{String(endM2).padStart(2,"0")}</div>
